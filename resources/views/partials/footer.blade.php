...
<footer class="footer">
      ...
      <div class="row gy-3 gy-md-5 gy-xl-0 align-items-sm-center">
        <div class="col-xs-12 col-sm-6 col-xl-3 order-0 order-xl-0">
          <div class="footer-logo-wrapper text-center text-sm-start">
            <a href="login">
              <img src="images/LogoR.png" alt="" width="175" height="80">
            </a>
          </div>
        </div>
  ...
  <div class="bg-light py-1 py-md-5 border-top border-light-subtle">
    <div class="container overflow-hidden">
      <div class="row mt-2">
        <div class="col">
          ...
          <div class="credits text-secondary text-center mt-2 fs-8">
            Built by <a href="https://bootstrapbrain.com/" class="link-secondary text-decoration-none">KKN UNIMMA Gandusari Hijau</a> Lestari
          </div>
        </div>
      </div>
    </div>
